# flake8: noqa
# disable flake8 check in order to not disable check for each print;
# printing for debuging is not welcomed (better to use logging),
# but for my taste it's the best option when it comes to prettifying output
